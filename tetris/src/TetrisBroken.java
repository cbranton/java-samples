...
public class TetrisBroken extends JPanel {
    ...
    private final Point[][][] Tetraminos = {
            // I-Piece
            { { new Point(0, 1), new Point(1, 1), new Point(2, 1), new Point(3, 1) },  //Initial rotation
                    { new Point(1, 0), new Point(1, 1), new Point(1, 2), new Point(1, 3) }, //90 degree rotation
                    { new Point(0, 1), new Point(1, 1), new Point(2, 1), new Point(3, 1) }, //180 degree rotation
                    { new Point(0, 0), new Point(0, 0), new Point(0, 0), new Point(0, 0) } }, //270 degree rotation
            // J-Piece
